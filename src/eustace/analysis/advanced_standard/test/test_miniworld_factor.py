"""Test of example using simulated data, low-resolution mesh, and factor analysis."""
...
class TestMiniWorldFactor(unittest.TestCase):
    ...
    def test_mini_world_noiseless(self):
        ...
        # Build system
        element = SpaceTimeFactorElement(n_triangulation_divisions=3, alpha=2, starttime=0, endtime=number_of_simulated_time_steps+1, n_nodes=number_of_simulated_time_steps+2, overlap_factor=2.5, H=1)
        ...
        # Simulated inputs
        simulated_input_loader = SimulatedInputLoader(fixed_locations, measurement, 0.01)
    ...
    def test_mini_world_large_and_local(self):
        ...
        # Large-scale factor
        element_large = SpaceTimeFactorElement(n_triangulation_divisions=3, alpha=2, starttime=0, endtime=number_of_simulated_time_steps+1, n_nodes=number_of_simulated_time_steps+2, overlap_factor=2.5, H=1)
