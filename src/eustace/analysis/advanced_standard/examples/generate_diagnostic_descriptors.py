...
from diagnosticfiller import DiagnosticJsonFiller
...
def main():
    ...
    parser.add_argument('n_iterations', type=int, default=2, help='number of solving iterations')
    ...
    filler = DiagnosticJsonFiller(args.n_iterations,
    ...
    filler.create_diagnostic_descriptor(args.descriptor_name, check_none=False)
