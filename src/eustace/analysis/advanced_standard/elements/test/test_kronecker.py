...
from eustace.analysis.advanced_standard.elements.kronecker import SpaceTimeKroneckerDesign
from eustace.analysis.advanced_standard.elements.kronecker import SpaceTimeKroneckerPrior
...
class TestSpaceTimeKroneckerElement(unittest.TestCase):
    ...
    def test_init(self):
        ...
        element = SpaceTimeKroneckerElement(n_triangulation_divisions=3, alpha=2, starttime=23, endtime=27, n_nodes=5, overlap_factor=2.5, H=1.2)
    ...
    def test_element_design(self):
        ...
        element = SpaceTimeKroneckerElement(n_triangulation_divisions=1, alpha=2, starttime=23, endtime=27, n_nodes=5, overlap_factor=2.5, H=1.2)
        design = element.element_design(TestSpaceTimeKroneckerElement.SimulatedObservationStructure())
        self.assertTrue(isinstance(design, SpaceTimeKroneckerDesign))
...
class TestSpaceTimeKroneckerDesign(unittest.TestCase):

    def test_init(self):

        design = SpaceTimeKroneckerDesign(
            observationstructure=TestSpaceTimeKroneckerElement.SimulatedObservationStructure(),
    ...
    def test_design_state_parameters(self):
        ...
        numpy.testing.assert_equal(numpy.zeros(210,), design.design_initial_state())
    ...
    def test_design_function(self):
        ...
        numpy.testing.assert_almost_equal(design.design_function(state_vector), [ 40.0 , 28.0 ])
...
class TestSpaceTimeKroneckerPrior(unittest.TestCase):

    def setUp(self):

        self.prior = SpaceTimeKroneckerPrior(
    ...
    def test_prior_number_of_state_parameters(self):
        ...
        self.assertEqual(210, self.prior.prior_number_of_state_parameters())
    ...
    def test_prior_precision(self):
        ...
        # Should have dimension 210 (because spatial subdivision has dimension 42 and there are 5 time points)
