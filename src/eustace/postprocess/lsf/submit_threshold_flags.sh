#!/bin/bash
#
# submit_threshold_flags.sh
#
# Derive flags the indicate large uncertainty or weak local observation constraint
#

# parameters
LSF_FILENAME=flagging_job_thresholds.sh  # script to run
...
export LOGDIR="/work/scratch/cmorice/lsf/mask_threshold/${ANALYSIS_VERSION}/"
export OUTPUT_DIRECTORY="/work/scratch/cmorice/masking/${ANALYSIS_VERSION}/threshold_C${CLIMATOLOGY_THRESHOLD}_L${LARGESCALE_THRESHOLD}_T${CONSTRAINT_THRESHOLD}/"
