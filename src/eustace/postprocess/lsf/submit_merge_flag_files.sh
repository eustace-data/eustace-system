#!/bin/bash
#
# submit_merge_flag_file.sh
#
# Combine bit mask flagging information from previously flagging steps into
# combined flag files.

# parameters
LSF_FILENAME=masking_job_merge.sh  # script to run
...
export LOGDIR="/work/scratch/cmorice/lsf/flag_merge/${ANALYSIS_VERSION}/"
export INPUT_DIRECTORY_1="/work/scratch/cmorice/masking/${ANALYSIS_VERSION}/outlier_window_W${OUTLIER_WINDOW_RANGE}_C${OUTLIER_COUNT_THRESHOLD}/"
export INPUT_DIRECTORY_2="/work/scratch/cmorice/masking/${ANALYSIS_VERSION}/threshold_C${CLIMATOLOGY_THRESHOLD}_L${LARGESCALE_THRESHOLD}_T${CONSTRAINT_THRESHOLD}_window_W${WINDOW_RANGE}_C${COUNT_THRESHOLD}_calendar_extended/"
export OUTPUT_DIRECTORY="/work/scratch/cmorice/masking/${ANALYSIS_VERSION}/outlier_window_W${OUTLIER_WINDOW_RANGE}_C${OUTLIER_COUNT_THRESHOLD}_threshold_C${CLIMATOLOGY_THRESHOLD}_L${LARGESCALE_THRESHOLD}_T${CONSTRAINT_THRESHOLD}_window_W${WINDOW_RANGE}_C${COUNT_THRESHOLD}_calendar_extended/"
