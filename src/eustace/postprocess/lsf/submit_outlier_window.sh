...
# parameters
LSF_FILENAME=outlier_job_window.sh  # script to run
...
export INPUT_DIRECTORY="/work/scratch/cmorice/masking/${ANALYSIS_VERSION}/outlier_flags/"

export LOGDIR="/work/scratch/cmorice/lsf/outlier_window/${ANALYSIS_VERSION}/"

export WINDOW_RANGE=10 #15
export COUNT_THRESHOLD=10 # 5

export OUTPUT_DIRECTORY="/work/scratch/cmorice/masking/${ANALYSIS_VERSION}/outlier_window_W${WINDOW_RANGE}_C${COUNT_THRESHOLD}/"
