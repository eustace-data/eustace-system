#!/bin/bash
#
# submit_outlier_flagging.sh
# 
# Submit jobs for detecting extreme values. Checks for a global maximum and minimum
# threshold exceedance and for outliers in comparison to a surrounding window
# of nearby locations.

# parameters
LSF_FILENAME=outlier_job.sh  # script to run
...
export LOGDIR="/work/scratch/cmorice/lsf/outlier_flagging/${ANALYSIS_VERSION}/"

export OUTPUT_DIRECTORY="/work/scratch/cmorice/masking/${ANALYSIS_VERSION}/outlier_flags/"
