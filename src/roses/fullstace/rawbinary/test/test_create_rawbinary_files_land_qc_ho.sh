#!/bin/bash
#
# test_create_rawbinary_files_land_qc_ho.sh
#
...
DIRECTORY="/work/scratch/$USER/rawbinary_test_land_qc_ho"
echo "$DIRECTORY"
...
--pathdefault $DIRECTORY \
--update \
test_rawbinary_generation_land_with_qc_with_holdout.json \
$DIRECTORY/catalogue.nc
...
$DIRECTORY/catalogue.nc \
--allow_unversioned_code \
|& tee testoutput/test_buildall_lookups_out_qc_ho.txt
...
$DIRECTORY/catalogue.nc \
--allow_unversioned_code \
|& tee testoutput/test_buildall_rawbinary_out_qc_ho.txt
