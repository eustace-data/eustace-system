...
FIRST_ITERATION="0"
LAST_ITERATION="5"
GRID_LAST_ITERATION="1"
START_DATE="18800101"
END_DATE="20151231"
DESCRIPTOR_NAME="advstd_iterations.json"
...
python -m eustace.analysis.advanced_standard.examples.generate_json_descriptors $INPATH $OUTPATH $FIRST_ITERATION $LAST_ITERATION $GRID_LAST_ITERATION $START_DATE $END_DATE $DESCRIPTOR_NAME \
