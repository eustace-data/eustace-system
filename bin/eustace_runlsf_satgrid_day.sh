#!/bin/bash
#
# eustace_runlsf_satgrid_day.sh
#
# Launch satgrid on parallel computing cluster.
# Options set for processing daytime measurements.
#
#
...
export DAYNIGHT="day"          # day/night flag to include in filename
...
export QC_FILTER_OBS=0         # QC bit values at all observations of interest
export QC_FILTER_VALID=0       # QC bit values at valid observations
